                ...
                <?php if(!empty($resultCompras)) { ?>
                    <?php foreach ($resultCompras as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="TiendaControl.php?opcion=compra-editar&idCom=<?php echo $value['id'] ?>">Editar</a> - 
                                <a href="TiendaControl.php?opcion=compra-eliminar&idCom=<?php echo $value['id'] ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php } ?>
                <?php } ?>
